...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <-- correctly positioned for static files
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # safer, cross-platform
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database (leave your options commented out or use env vars for security)
